...
<body>
    <form action="procesarRegistro" method="POST" onsubmit="return validarUsuario();">
        ...
        <input 
            ...
            required
            pattern="[A-Za-z0-9_.]+" 
            title="El nombre de usuario solo puede contener letras, números, guiones bajos (_) y puntos (.)"
        >
    ...
    <script>
        function validarUsuario() {
            ...
            if (!regex.test(nombreUsuario)) {
                alert("El nombre de usuario solo puede contener letras, números, guiones bajos (_) y puntos (.)");
                return false;
            }
            return true;
        }
